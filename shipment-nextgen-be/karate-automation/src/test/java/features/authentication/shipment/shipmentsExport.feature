Feature: Shipments > Export Permission

  Background:
    * url baseUrl
    * def bearer = token

    * def userCredentials = 'classpath:session/json/shipments_export.json'
  ...
  @Permissions
  Scenario: Happy path: Shipment Exporter retrieves a shipment
  ...
  @Permissions
  Scenario: Unhappy path: Shipment Exporter updates a shipment
  ...
  @Permissions
  Scenario: Happy path: Shipment Exporter exports a shipment
