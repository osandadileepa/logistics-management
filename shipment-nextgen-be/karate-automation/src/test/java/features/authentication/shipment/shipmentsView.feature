Feature: Shipments > View Permission

  Background:
    * url baseUrl
    * def bearer = token

    * def userCredentials = 'classpath:session/json/shipments_view.json'
  ...
  @Permissions
  Scenario: Happy path: Shipment Viewer retrieves a shipment
  ...
  @Permissions
  Scenario: Unhappy path: Shipment Viewer updates a shipment
  ...
  @Permissions
  Scenario: Unhappy path: Shipment Viewer exports a shipment
