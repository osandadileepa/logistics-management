Feature: Search by Facility Location Feature
  ...
  Background:
    ...
    * findAllRequest.data.facility_locations.country_ids = []
    * findAllRequest.data.facility_locations.country_ids[0] = countryId
    * print findAllRequest


  @ShipmentFindAllByFacilityLocation @Regression
