Feature: Search by Destination Location Feature
  ...
  Background:
    ...
    * def countryId = shipment.destination.country
    * print countryId
    * def findAllRequest = read('classpath:features/shipment/json/search/listAllByOriginLocationRQ.json')
    * print findAllRequest
    * findAllRequest.data.destination_locations.country_ids = []
    * findAllRequest.data.destination_locations.country_ids[0] = countryId
    * print findAllRequest

  @ShipmentFindAllByDestinationLocation @Regression
