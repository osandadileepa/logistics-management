...
Feature: Retrieve Currencies on QPortal
  ...
  @ignore
  @QPortalListCurrencies
  Scenario: Retrieve Currencies
    Given url utils.decodeUrl(baseUrl + '/qportal/currencies?organizationId=' + organization_id)
