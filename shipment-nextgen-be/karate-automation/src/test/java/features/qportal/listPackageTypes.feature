...
Feature: Retrieve Package Types on QPortal
  ...
  @ignore
  @QPortalListPackageTypes
  Scenario: Retrieve Package Types
    Given url utils.decodeUrl(baseUrl + '/qportal/package_types?organizationId=' + organization_id)
  ...
  @ignore
  @QPortalListPackageTypes
  Scenario: Retrieve Package Types with invalid organization id
