Feature: Simulate Milestone Message from Dispatch
  ...
  @SimulateMilestoneMessageWithShipmentLostStatusCodeFromDispatch
  @Utility
  @Regression
  Scenario: Simulate Milestone Message With Shipment Lost Status Code from Dispatch
    ...
    * milestoneMessage.milestone_code = '1506'
    ...
    * match data.milestone_events[0].milestone_code == '1506'