Feature: Simulate Milestone Message from Dispatch
  ...
  @Utility
  @Regression
  Scenario: Simulate Milestone Message With Route To Pick Up Status Code from Dispatch
    ...
    * milestoneMessage.milestone_code = '1401'
    ...
    * def response = $
    * def data = response.data
    * match data.milestone_events[0].milestone_code == '1401'
