...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        final S2STokenAuthenticationFilter s2STokenAuthenticationFilter = new S2STokenAuthenticationFilter(authenticationProvider, tokenResolver, securityProperties.getToken().getValue());
